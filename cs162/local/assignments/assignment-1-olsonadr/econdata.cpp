    ...
    std::ifstream & data_file)
{
    ...
    if (argc == 1)
    {
        std::cout << "**ERROR! No path to file provided.**"
                  << std::endl;
        return 1;
    }
    ...
    std::ifstream & data_file)
{
    ...
    if (data_file.fail())
    {
        std::cout << "**ERROR! Failed to read number of states.**"
                  << std::endl;
        return -1;
    }
...
** Parameters:		struct state state_to_display:
...
** Parameters:		struct county county_to_display:
